...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      formattedDatetime() {
        return this.selectedDatetime ? this.$d(new Date(this.selectedDatetime), 'long') : ''
      },
      selectedDatetime() {
    ...
    methods: {
      init() {
        ...
        this.date = format(new Date(this.datetime), DEFAULT_DATE_FORMAT)
        this.time = format(new Date(this.datetime), DEFAULT_TIME_FORMAT)
      },
      okHandler() {
        this.resetPicker()
